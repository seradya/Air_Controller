...
#define RX_ADDR_P3 0x0D //'RX address pipe2' register address
#define RX_ADDR_P4 0x0E //'RX address pipe2' register address
#define RX_ADDR_P5 0x0F //'RX address pipe2' register address
...
#define RХ_P_0 0x0 //Pipe 0 for payload in RX_FIFO
#define RХ_P_1 0x1 //Pipe 1 for payload in RX_FIFO
#define RХ_P_2 0x2 //Pipe 2 for payload in RX_FIFO
#define RХ_P_3 0x3 //Pipe 3 for payload in RX_FIFO
#define RХ_P_4 0x4 //Pipe 4 for payload in RX_FIFO
#define RХ_P_5 0x5 //Pipe 5 for payload in RX_FIFO
